...
import com.example.devopsjava.springboot.project.entities.RoleToUser;
...
public class UserController {
    ...
    public ResponseEntity<?> updateUser(@PathVariable("userId") Long userId,
        ...
        return ResponseEntity.created(uri).body(userService.updateUser(userId, name, userName));
    }
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
            try {
                ...
                DecodedJWT decoderJWT = verifier.verify(refreshToken);
